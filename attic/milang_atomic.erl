...
'atomic'(Input, Index) ->
  p(Input, Index, 'atomic', fun(I,D) -> (p_choose([fun 'space'/2, fun 'function_name'/2, fun 'type_name'/2, fun 'variable'/2, fun 'infix'/2, fun 'bindable_function_name'/2]))(I,D) end, fun(Node, _Idx) ->Node end).
